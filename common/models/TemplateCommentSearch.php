...
/**
 * TemplateCommentSearch represents the model behind the search form of `common\models\TemplateComment`.
 */
class TemplateCommentSearch extends TemplateComment
{
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'lower(comment)', strtolower($this->comment)]);
