...
class SiteApiCredentialSearch extends SiteApiCredential
{
    ...
    {
        return [
            [['id', 'site_id', 'type', 'status', 'created_at', 'updated_at'], 'integer'],
            [['client_name', 'client_api_key', 'client_secret', 'description', 'package_name', 'certificate_fingerprint', 'bundle_id', 'appstore_id'], 'safe'],
        ];
    }
