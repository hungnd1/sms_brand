...
CREATE TABLE `exam_room` (
  ...
  `exam_id` INT COMMENT '',
  `subjects` VARCHAR(500) NULL COMMENT '',
  `students` VARCHAR(1024) NULL COMMENT '',
  `locations` VARCHAR(1024) NULL COMMENT '',
  `supervisory` VARCHAR(1024) NULL COMMENT '',
  `exam_hours` VARCHAR(1024) NULL COMMENT '',
  `exam_dates` VARCHAR(1024) NULL COMMENT '',
