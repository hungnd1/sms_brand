...
<div class="form-body">
    ...
    <?php
        echo $form->field($model, 'id')->widget(Select2::classname(), [
            'data' => \yii\helpers\ArrayHelper::map(\common\models\User::getUserBrandnameUpdate($model->id), 'id', 'username'),
    ...
    <div class="form-actions">
        <div class="row">
            <div class="col-md-offset-3 col-md-9">
                <?= Html::submitButton("Cập nhật brandname ",['class' => 'btn btn-success','value'=>'owner-update']) ?>
