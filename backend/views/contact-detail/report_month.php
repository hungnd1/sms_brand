        ...
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green-sharp bold uppercase">Báo cáo tháng</span>
                </div>
                <div class="tools">
            ...
            <div class="portlet-body">
                ...
                $gridColumns = [
                    ...
                    [
                        ...
                        'value' => function ($model, $key, $index, $widget) {
                            /** @var $model \common\models\HistoryContactAsm */
                            return substr(HistoryContact::getContent($model), 0, 60);
                    ...
                    [
                        ...
                        'value' => function ($model, $key, $index, $widget) {
                            /** @var $model \common\models\HistoryContactAsm */
                            return \common\models\HistoryContactAsm::getBrandname($model);
